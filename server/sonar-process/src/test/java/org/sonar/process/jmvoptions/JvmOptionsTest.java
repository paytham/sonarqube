...
public class JvmOptionsTest {
  ...
  @Test
  @UseDataProvider("variousEmptyStrings")
  public void addFromMandatoryProperty_has_no_effect_if_property_contains_an_empty_value(String emptyString) {
    properties.put(randomPropertyName, emptyString);
